  ...
  return (
    <div className="relative w-full h-full flex items-center justify-center">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center gap-stack-lg max-w-[1200px] mx-auto px-[64px] text-center">
        <h1 className="font-display-lg text-display-lg md:text-[64px] text-secondary tracking-tight leading-[1.05] drop-shadow-[0_0_30px_rgba(240,192,62,0.8)]">
          {EVENT_TITLE}
        </h1>

        <p className="font-label-caps text-label-caps text-on-surface-variant animate-slow-pulse tracking-[0.2em] uppercase">
          Get Ready.
        </p>
      </main>
    </div>
